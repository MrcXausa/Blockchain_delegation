...
function RegisterInstitution({setDisplay}){
    ...
    async function handleSubmit(e){
        ...
        fetch("http://localhost:3000/v2/registerinstitution",{
            method:'POST',
        ...
        .then(async (response) => {
            if(response.stored===false)
                ...
                console.log("pk= "+process.env.REACT_APP_CONTRACT_OWNER_PRVATEKEY);
                console.log("owner= "+owner.address);
                web3.eth.accounts.wallet.add(owner);

                let authorized1=await contract.methods.isAuthorizedInstitution(accounts[0]).call({ from: owner.address});
                console.log("Institution authorized before="+authorized1);
                ...
                authorized1=await contract.methods.isAuthorizedInstitution(accounts[0]).call({ from: owner.address});
                console.log("Institution authorized="+authorized1);
